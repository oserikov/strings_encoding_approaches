...
from toy_caesar_coder import ToyTranslitCaesarStringsCoder


class TestToyTranslitCaesarStringsCoder(TestCase):

    def setUp(self):
        # YOUR CODE HERE
        # DO NOT TOUCH OTHER METHODS
        self.coder_tool = ToyTranslitCaesarStringsCoder(1)
